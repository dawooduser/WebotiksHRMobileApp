...
const TextInputCB = ({ placeHolderText, IconView, passwordField, textStyleContainer }) => {
    ...
    return (
        <View style={[commonStyles.rowDirectionCenter, commonStyles.fullWidth, styles.container, commonStyles.shadow]}>
            ...
            style={[styles.textContainer, !passwordField && styles.borderLeftRadius, textStyleContainer ]} />
            <PasswordBtnViewer />
            </View>
        </View>
    )
